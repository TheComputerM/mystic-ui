...
import { createEffect, mergeProps, splitProps, type Component, type JSX } from "solid-js";
...
export const NoSignalScreen: Component<NoSignalScreenProps> = (props) => {
  ...
  return (
    <canvas
      ref={canvasRef}
      class={cn("pointer-events-none opacity-50 absolute inset-0 size-full", localProps.class)}
      {...forwardProps}
    />
  );
};